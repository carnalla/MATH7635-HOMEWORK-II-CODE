...
The best prediction accuracy in this problem (somewhat ironically) was the logistic regression model using the 'Lag2' and 'Year' interaction variable. It achieved an accuracy of 62.5% which is no better than the prior logistic regression model in this same problem. The associated confusion matrix is shown below. Cumulatively, this was not an easy problem, and maybe reflects real-world difficulty associated with accurately forecasting changes in the stock market.
